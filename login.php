...
<title>AK作业答案互助平台_登录</title>
<meta charset="utf-8">
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
</head>
<body>
<h1>学校18班AK作业答案互助平台登录</h1>
...
<button id="regg">登录哦</button>
<a href="https://a.ordylan.cn/r/">注册1[限雨中2020-18班的同学]</a>
<a href="#">注册2[游客](待开发)</a>
<a href="https://a.ordylan.cn/">返回首页</a><br>
您的账号安全,我们来负责!!<您输入的密码将以MD5(数据库存放的是您密码加随机橙汁后的MD5)进行加密匹配!>
...
$('#regg').click(function() {
    var a = $("#pwd").val();
        //a = a + "_ORDYLAN_ANSWER_KILLER!!";
        //a = a.MD5(32);
       $.ajax({
            url:"https://a.ordylan.cn/apis/login.php?" + Math.random(),
            type:"POST",
            data:{
                id:$("#id").val(),
                pwd:a//,
            ...
            success:function (resa) {
                //changeImg();
                if(resa == "验证码错了哦哦"){}
                else if(resa == "登录成功啦啦!"){window.location.href="/?" + Math.random();}
                alert(resa);
            }
        })         
});
